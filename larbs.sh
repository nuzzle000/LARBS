...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/nuzzle000/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/nuzzle000/LARBS/master/progs.csv"
